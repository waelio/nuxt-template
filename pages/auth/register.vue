<template>
  <div class="limiter img-background">
    <div class="container-login100 scroll">
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        <q-form class="login100-form validate-form content-lg-between">
          ...
          <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
              ...
              <q-btn
                ...
                class="primary login100-form-btn"
                :disable="!valid"
                @click.prevent="localSignup"
              >
                Signup
              </q-btn>
            </div>
          ...
          <div class="flex-c-m">
            <a class="login100-social-item bg1">
              <q-icon
                name="facebook"
                @click="$emit('onAuthenticate', 'facebook')"
              ></q-icon>
            </a>
            <a class="login100-social-item bg2">
              <q-icon name="twitter" @click="$emit('onAuthenticate', 'twitter')"></q-icon>
            </a>
            <a class="login100-social-item bg3">
              <q-icon
                background="bg-white"
                name="google"
                @click="$emit('onAuthenticate', 'google')"
              ></q-icon>
            </a>
          </div>
          <div class="flex-col-c q-py-sm">
            <NuxtLink to="/auth/login" class="txt2">Login</NuxtLink>
          </div>
          <div class="flex-col-c q-py-sm">
            <span class="txt1 p-b-17">Or Skip</span>
            <NuxtLink to="/" class="txt2">Home</NuxtLink>
          </div>
        </q-form>
      </div>
    </div>
